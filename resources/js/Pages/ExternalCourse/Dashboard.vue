<template>
    <app-layout :title="$t('external_course_views_completions')">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ $t('external_course_views_completions') }}
            </h2>
        </template>
                    ...
                    <div class="w=full mt-6 flex items-center justify-between">
                        ...
                        <div>
                            <a
                                ...
                                href="/external-course/create">
                                {{ $t('add_external_course') }}
                            </a>
                        </div>
                        <div>
...
import TablePerFiscalYear from '@/Pages/ExternalCourse/Partials/TablePerFiscalYear.vue';
import TablePerFiscalYearAndQuarter from '@/Pages/ExternalCourse/Partials/TablePerFiscalYearAndQuarter.vue';
import ViewsFilter from '@/Pages/ExternalCourse/Partials/Filter.vue';
...
export default {
    ...
    methods: {
        applyFilters(filters) {
            ...
            this.$inertia.visit(`/external-course/dashboard?${query}`);
        }
    },
}
</script>
