...
class GetExternalCourseViewsAndCompletionsDashboardController extends Controller
{
    private $repo;

    public function __construct(ExternalCourseContract $repo)
    {
        $this->repo = $repo;
    }
    ...
    public function __invoke(Request $request) {
        ...
        return Inertia::render('ExternalCourse/Dashboard', $data);
    }
}
